...
*(Note: The stock Metro 328 has an always-on power LED and USB converter, and the MPX5010DP sensor doesn't have a power-down pin. We must count their idle usage unless hardware modifications are made, such as adding a transistor to cut sensor power).*
